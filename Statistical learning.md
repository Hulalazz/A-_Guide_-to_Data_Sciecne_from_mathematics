...
- [A Guide to Data Science](#a-guide-to-data-science)
- [Statistical Foundation](#statistical-foundation)
  - [Basic Probability](#basic-probability)
    ...
    - [Continuous Distribution](#continuous-distribution)
      ...
      - [Link between discrete and continuous distributions](#link-between-discrete-and-continuous-distributions)
    - [Bivariate Distribution](#bivariate-distribution)
      - [The marginal distribution](#the-marginal-distribution)
    - [Representation of Random Variable](#representation-of-random-variable)
      - [Mixture Representation](#mixture-representation)
  - [Bayes' Theorem](#bayes-theorem)
    - [Conditional Probability](#conditional-probability)
    - [Total Probability Theorem](#total-probability-theorem)
    - [Bayes' Theorem](#bayes-theorem-1)
    - [Inverse Bayes' Formula](#inverse-bayes-formula)
  - [What determines a distribution?](#what-determines-a-distribution)
    - [Expectation, Variance and Entropy](#expectation-variance-and-entropy)
    - [Moment and Moment Generating Function](#moment-and-moment-generating-function)
  - [Sampling Methods](#sampling-methods)
    - [Sampling from Discrete Distribution](#sampling-from-discrete-distribution)
      - [Sampling from Categorical Distribution](#sampling-from-categorical-distribution)
    - [Sampling from Continuous Distribution](#sampling-from-continuous-distribution)
      - [Direct Methods](#direct-methods)
      - [Rejection sampling](#rejection-sampling)
      - [Sampling-importance-resampling](#sampling-importance-resampling)
      - [The Conditional Sampling Method](#the-conditional-sampling-method)
        - [The Vertical Density Representation Method](#the-vertical-density-representation-method)
...
- [Statistical Estimation](#statistical-estimation)
  - [The Method of Moments Estimator](#the-method-of-moments-estimator)
  - [Maximum Likelihood Estimation](#maximum-likelihood-estimation)
  - [Bayesian Estimation of Parameters](#bayesian-estimation-of-parameters)
  - [Confidence Interval Estimation](#confidence-interval-estimation)
    - [Goodness of Fit](#goodness-of-fit)
- [Numerical Optimization](#numerical-optimization)
  - [Gradient Descent and More](#gradient-descent-and-more)
  - [Mirror Gradient Method](#mirror-gradient-method)
    - [Projected Gradient Descent](#projected-gradient-descent)
    - [Mirror descent](#mirror-descent)
  - [Variable Metric Methods](#variable-metric-methods)
    - [Newton's Method](#newtons-method)
    - [The Fisher Scoring Algorithm](#the-fisher-scoring-algorithm)
...
- [Regression Analysis and Machine Learning](#regression-analysis-and-machine-learning)
  ...
  - [Machine Learning](#machine-learning)
    ...
    - [Bootstrapping Methods](#bootstrapping-methods)
...
- [Deep Learning](#deep-learning)
  ...
  - [Convolutional Neural Network](#convolutional-neural-network)
    ...
    - [CNN](#cnn)
    - [Visualization of CNN](#visualization-of-cnn)
...
- [Probabilistic Programming and Topological Data Analysis](#probabilistic-programming-and-topological-data-analysis)
