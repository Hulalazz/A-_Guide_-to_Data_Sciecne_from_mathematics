...
$$\operatorname{sparsemax}(\theta)=\arg\max_{y\in\Delta_k}y^T\theta+\|y\|_2^2=\arg\max_{y\in\Delta_k}\|\theta-y\|_2^2$$
which is an Euclidean projection onto the simplex.

<img src="https://raw.githubusercontent.com/vene/sparsemap/master/sparsemap.png" width="50%" />

And we would like some sparsity
$$\arg\max_{y\in\Delta_k}y^T\theta+\|y\|_1.$$
...
- https://arxiv.org/abs/1707.00409
...
<img src="https://raw.githubusercontent.com/cvqluu/Angular-Penalty-Softmax-Losses-Pytorch/master/figs/cosface.png" />
...
<img src="https://pic4.zhimg.com/80/v2-e6d3e7a67ff6d28da996322cb9855bb3_720w.jpg" width="70%"/>
